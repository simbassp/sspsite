...
/** Как часто шлём heartbeat, пока вкладка видима (legacy; клиент больше не poll-ит по таймеру). */
...
/** Как часто обновлять шапку (достижения, косметика) при открытой вкладке. */
export const APP_SHELL_BOOTSTRAP_POLL_MS = 5 * 60 * 1000;
